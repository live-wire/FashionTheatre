<html>
	...
	<?php
		...
		$rs=mysql_query("select Department_name,Department_id from Department where Category_id=\"men\" order by Department_name");
	?>
	<div id="base">
		...
		<div id="base2"><img src="mens2.jpg" width="100%" height="100%"></div>
	</div>
